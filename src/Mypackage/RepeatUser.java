...
public class RepeatUser {
	...
	//	System.setProperty("webdriver.chrome.driver", "C:\\Automation\\Deiver\\chromedriver.exe");
	    ...
	    driver.findElement(By.id("new-mobile")).sendKeys("9768768767");
	    ...
	    driver.findElement(By.name("order_id")).sendKeys("5810");
	    ...
	    Thread.sleep(2000);
	    //driver.findElement(By.xpath("//button[@class='bg-primary text-darkGreen  snap-primary-button w-full mt-[8px]']")).click();
	    //System.out.println("click EMI button");
	    ...
	    driver.findElement(By.xpath("//*[@class=' bg-secondaryText snap-primary-button text-xl w-full mt-[6px]']")).click();
	    System.out.println("Enter Verify button");
	    Thread.sleep(2000);*/
	    //driver.findElement(By.xpath("//button[@class='bg-primary text-darkGreen  snap-primary-button text-xl w-full mt-[6px]']")).click();
	     
        //driver.findElement(By.xpath("//button[@class='bg-primary text-darkGreen snap-primary-button w-[100%] px-[0px]]")).click();
       // driver.findElement(By.xpath("//input[@id='upiId']")).sendKeys("77777777777@paytm");
        //System.out.println("Enter UPI ID");
        
       // driver.findElement(By.xpath("//img[@class='w-[18px] h-[18px] mt-[2px]']")).click();
        //System.out.println("Enter UPI ID");
	     // driver.findElement(By.xpath("//input[@class='bg-primary text-darkGreen  snap-primary-button w-[100%] px-[0px]']")).click();
	   ...
	   //button[@class=" bg-secondaryText snap-primary-button py-[16px] h-[40PX] w-[164px] mx-auto text-[12px] mt-[12px]"]	}
	
	    // driver.findElement(By.xpath("//*[@class='flex relative gap-[12px] items-center w-full h-[48px] cursor-pointer text-headGreen bg-white before:bg-[#ffffff] before:h-[47px] before:w-[8px] before:absolute  before:content-[''] before:left-[-4px] before:z-[99] after:bg-[#ffffff] after:h-[47px] after:w-[8px] after:absolute  after:content-[''] after:right-[-4px] after:z-[99]  border-[#DEDEDE] border-y-[0.3px] font-robotoBold']")).click();
	    // driver.findElement(By.xpath("//*[@class='item-center w-[38px] h-[38px] bg-[#fff] border-[#70C1CC] border-2 rounded-[4px]']")).click();
	     //driver.findElement(By.xpath("//button[@class='bg-primary text-darkGreen  snap-primary-button py-[16px] h-[40PX] w-[164px] mx-auto text-[12px]']")).click();
