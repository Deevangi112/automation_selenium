...
public class qasnapmint {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath(
				"//div[@class='flex items-center xl:mr-4 w-[50%] justify-end gap-8 mr-8']/div[3]/button[@class='whitespace-nowrap cursor-pointer text-[#014751] font-robotoRegular text-[14px] leading-[18px] sm:text-sm']"))
				.click();

		driver.findElement(By.xpath("//div[@class='relative pl-2']/input[@name='mobile']")).sendKeys("9647583496");

		driver.findElement(By.xpath(
				"//button[@class='!bg-headerBlue hover:bg-headerBlue font-montserratMedium mt-4 text-lightYellow w-[144px] h-[40px] px-6 py-2.5 text-center font-bold text-sm rounded-md shadow hover:shadow-lg outline-none focus:outline-none mx-auto']"))
				.click();
